...
def process_single_file(file_path, target_column, output_dir):
    ...
    save_transformation_methods(transformed_df, os.path.join(analysis_folder, f'transformation_methods_{base_filename}.docx'))
...
if __name__ == "__main__":
    input_path = input("Enter path for file/folder")  # Single file or folder containing files
