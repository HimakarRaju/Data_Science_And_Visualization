...
class Analyser:
    ...
    def transform_data(self, model, X, y=None):
        try:
            # One-hot encode categorical variables for any applicable model
            ...
            # KMeans requires MinMax scaling
            elif isinstance(model, KMeans):
                scaler = MinMaxScaler()
                X_transformed = scaler.fit_transform(X)
                return X_transformed

            # GaussianNB expects label-encoded features
            ...
            # If none of the conditions are met, return the original
            return X, y
